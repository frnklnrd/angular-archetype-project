...
import { UTIL_CRYPTO_SECRET_KEY } from '../variable/variables';

@Injectable()
export class UtilCryptoManagerService {
  private readonly token: string;

  private secretKey: string = inject<string>(UTIL_CRYPTO_SECRET_KEY);
