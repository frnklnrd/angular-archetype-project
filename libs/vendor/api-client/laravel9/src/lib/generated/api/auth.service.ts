...
export class AuthService {
    ...
    public login(body?: any, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    ...
    public refreshToken(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/api/refreshToken`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public user(body?: any, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public user(body?: any, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public user(body?: any, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public user(body?: any, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
