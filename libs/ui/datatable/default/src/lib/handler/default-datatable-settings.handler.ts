...
import { DatatableColumnsSettings, DatatableDataSettings, DatatableViewSettings, PaginatedTableOneColumnSetting } from '@app/ui/datatable/api';

import { ColumnMode, SelectionType, SortType } from '@swimlane/ngx-datatable';

@Injectable()
export class DefaultDatatableSettingsHandler extends AbstractService {
  ...
  protected getDefaultColumnCheckboxableSettings(
    options: any = {}
  ): PaginatedTableOneColumnSetting {
    return {
      name: '',
      // prop: null,
      width: 50,
